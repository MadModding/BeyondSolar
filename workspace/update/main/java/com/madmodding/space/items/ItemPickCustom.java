...
public class ItemPickCustom extends ItemPickaxe implements IColorable {
	/**
	...
	public ItemPickCustom(String string, ToolMaterial material) {
		super(material);
	...
	public String getItemStackDisplayName(ItemStack stack) {
		if (!stack.hasTagCompound() || !stack.getTagCompound().hasKey("Name")
			...
			if (stack.getTagCompound().getInteger("Mode") == 0)
				...
				return stack.getTagCompound().getString("Name") + " Hammer";
			else
				return stack.getTagCompound().getString("Name") + " Pickaxe";
		}
	}
