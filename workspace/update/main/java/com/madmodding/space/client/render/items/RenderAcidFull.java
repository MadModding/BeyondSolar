...
import com.madmodding.space.client.models.ModelAcidFull;
...
public class RenderAcidFull extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation textures = new ResourceLocation("space:textures/models/AcidFullTexture.png");
	private ModelAcidFull model;

	@Override
	public void renderTileEntityAt(TileEntity p_147500_1_, double x, double y, double z, float p_147500_8_, int p_180535_9_) {
	    model = new ModelAcidFull();
		GL11.glPushMatrix();
