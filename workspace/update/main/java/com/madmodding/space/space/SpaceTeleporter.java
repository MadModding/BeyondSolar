...
public class SpaceTeleporter extends Teleporter
{
    ...
    public SpaceTeleporter(WorldServer worldIn)
    {
    	super(worldIn);
    ...
    public boolean placeInExistingPortal(Entity entityIn, float p_180620_2_)
    {
        ...
        if (d0 >= 0.0D)
        {
            if (flag1)
            {
                this.destinationCoordinateCache.add(k, new SpaceTeleporter.PortalPosition((BlockPos)object, this.worldServerInstance.getTotalWorldTime()));
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                SpaceTeleporter.PortalPosition portalposition = (SpaceTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
