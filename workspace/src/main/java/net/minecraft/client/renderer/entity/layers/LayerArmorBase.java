...
public abstract class LayerArmorBase implements LayerRenderer {
	...
	private void func_177182_a(EntityLivingBase p_177182_1_, float p_177182_2_, float p_177182_3_, float p_177182_4_,
		...
		if (itemstack != null && itemstack.getItem() instanceof ItemArmor) {
			...
			modelbase = net.minecraftforge.client.ForgeHooksClient.getArmorModel(p_177182_1_, itemstack, p_177182_9_,
					modelbase);
...

			{
				...
				if (j != -1) {
					...
					GlStateManager.color(this.field_177184_f * f7, this.field_177185_g * f8, this.field_177192_h * f9,
							this.field_177187_e);
					modelbase.render(p_177182_1_, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_,
							p_177182_8_);
					this.field_177190_a
							.bindTexture(this.getArmorResource(p_177182_1_, itemstack, flag ? 2 : 1, "overlay"));
				} else {
				...
				}
				{
					if (!this.field_177193_i && itemstack.isItemEnchanted()) {
						this.func_177183_a(p_177182_1_, modelbase, p_177182_2_, p_177182_3_, p_177182_4_, p_177182_5_,
	 ...
	 */
	public ResourceLocation getArmorResource(net.minecraft.entity.Entity entity, ItemStack stack, int slot,
			String type) {
