...
public class EntityFlameFX extends EntityFX
{
    ...
    protected EntityFlameFX(World worldIn, double p_i1229_2_, double p_i1229_4_, double p_i1229_6_, double p_i1229_8_, double p_i1229_10_, double p_i1229_12_)
    {
    ...
    public static class AmbientMobFactory implements IParticleFactory
        {
            ...
            {
                EntityFlameFX entityspellparticlefx = new EntityFlameFX(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
    ...
    public static class InstantFactory implements IParticleFactory
        {
            ...
            {
                EntityFlameFX entityspellparticlefx = new EntityFlameFX(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
                ((EntityFlameFX)entityspellparticlefx).setBaseSpellTextureIndex(144);
                return entityspellparticlefx;
            }
        }
