...
public class ItemAxeCustom extends ItemAxe implements IColorable {
	/**
	...
	public ItemAxeCustom(String string, ToolMaterial material) {
		super(material);
	...
	public String getItemStackDisplayName(ItemStack stack) {
		if (!stack.hasTagCompound() || !stack.getTagCompound().hasKey("Name")
			...
			if (stack.getTagCompound().getInteger("Mode") == 0)
				...
				return stack.getTagCompound().getString("Name") + " Battle-Hatchet";
			else
				return stack.getTagCompound().getString("Name") + " Axe";
		}
	}
