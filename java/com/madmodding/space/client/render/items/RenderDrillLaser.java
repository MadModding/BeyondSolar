...
public class RenderDrillLaser extends Render
{
    private static final ResourceLocation laserTextures = new ResourceLocation("space:textures/entity/laser.png");
    private static final String __OBFID = "CL_00000978";

    public RenderDrillLaser()
    {
        super(Minecraft.getMinecraft().getRenderManager());
    }

    public void doRender(EntityDrillLaser p_180551_1_, double p_180551_2_, double p_180551_4_, double p_180551_6_, float p_180551_8_, float p_180551_9_)
    {
    ...
    protected ResourceLocation getEntityTexture(EntityDrillLaser p_180550_1_)
    {
    ...
    {
        return this.getEntityTexture((EntityDrillLaser)entity);
    }
    ...
    {
        this.doRender((EntityDrillLaser)entity, x, y, z, p_76986_8_, partialTicks);
    }
}