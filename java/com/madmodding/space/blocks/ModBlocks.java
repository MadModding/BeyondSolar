...
import com.madmodding.space.blocks.tile.forge.BlockForge;
...
public final class ModBlocks {
	...
	public static final Block cellBlock = new Block(Material.iron).setUnlocalizedName("cellBlock").setLightLevel(1.0F)
			.setBlockUnbreakable().setCreativeTab(Main.aliensTabBlock);
	...
	public static final Block aluminiumOre = new SpaceOre(Material.rock).setUnlocalizedName("aluminiumOre")
			.setHardness(8.0F);
